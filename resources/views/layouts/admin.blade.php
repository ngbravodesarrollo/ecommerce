    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>ADNoray</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('almacen/articulos')}}"><i class="fa fa-circle-o"></i> Artículos</a></li>
                <li><a href="{{url('almacen/categorias')}}"><i class="fa fa-circle-o"></i> Categorías</a></li>
                <li><a href="{{url('almacen/metales')}}"><i class="fa fa-circle-o"></i> Metales</a></li>
                <li><a href="{{url('almacen/colecciones')}}"><i class="fa fa-circle-o"></i> Colecciones</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{url('ventas/clientes')}}"><i class="fa fa-circle-o"></i> Clientes</a></li>
              </ul>
            </li>
